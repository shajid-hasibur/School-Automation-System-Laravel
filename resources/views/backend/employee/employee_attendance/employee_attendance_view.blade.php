                            ...
                            <tbody class="">
                                ...
                                <tr>
                                    ...
                                    <td style="white-space: nowrap; width: 15%;">
                                        ...
                                        <a href="{{ route('employee.attendance.delete', $value->date) }}" class="tabledit-delete-button btn btn-danger" style="margin: 1px; float: none;" id="delete"><span class="ti-trash"></span></a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
