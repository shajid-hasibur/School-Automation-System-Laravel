        ...
        <div class="col-lg-12">
            <div class="card m-b-30">
                <div class="card-header">
                    ...
                    <a href="{{ route('exam.type.create') }}" class="btn btn-primary" style="float: right;">Add Exam Type</a>
                </div>
                <div class="card-body">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="white-space: nowrap; width: 15%;">
                                        <a href="{{ route('exam.type.edit', $examType->id) }}" style="float: none; margin: 5px;" class="tabledit-edit-button btn btn-sm btn-info"><span class="ti-pencil"></span></a>

                                        <a href="{{ route('exam.type.delete', $examType->id) }}" class="tabledit-delete-button btn btn-sm btn-danger" style="margin: 5px; float: none;" id="delete"><span class="ti-trash"></span></a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
