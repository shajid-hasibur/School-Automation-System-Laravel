                    ...
                    <form method="POST" action="{{ route('lessons.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2 {{ $errors->has('subject') ? 'is-invalid' : '' }}" name="subject_id" id="subject_id" required>
                                ...
                                <option value="{{ $id }}" {{ old('class_id') == $id ? 'selected' : '' }}>{{ $subject }}</option>
                                @endforeach
                            </select>
                            @if($errors->has('class'))
                            <div class="invalid-feedback">
                        ...
                        <div class="form-group">
                            <label class="required" for="weekday">Weekday (Example: 1)</label>
                        ...
                        <div class="form-group">
                            <label class="required" for="start_time">start_time (example: 10:00)</label>
                        ...
                        <div class="form-group">
                            <label class="required" for="end_time">end_time (example: 10:00)</label>
